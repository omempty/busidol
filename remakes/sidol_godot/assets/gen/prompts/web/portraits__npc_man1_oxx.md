# [요청] 화공과 남학생 (npc_man1_oxx) — 대화 초상 시트 1장

## 인물 (이게 그림에 보여야 한다)
- 고정 서술 토큰: 화공과 남학생: 안경+실험복, 다리에 붕대. 진지하지만 사물함 같은 말투
- 신원 표지 — 하나라도 빠지면 **다른 인물**이다:
  - [ ] 안경+실험복
  - [ ] 다리에 붕대. 진지하지만 사물함 같은 말투
...
|---|---|---|
| 1 | normal | 기본 — 평상시 얼굴 |
| 2 | stoic | 무덤덤 — 감정을 드러내지 않는 굳은 얼굴 |
| 3 | injured | 부상 — 이마·볼에 반창고나 멍, 한쪽 눈을 찡그린다 |
