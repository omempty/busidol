# [요청] 수위 아저씨 (npc_guard) — 대화 초상 시트 1장

## 인물 (이게 그림에 보여야 한다)
- 고정 서술 토큰: 수위 아저씨: 근육질 노인 경비, 모자+조끼, 여유로운 미소. 공대 최강자 개그 캐릭터
- 신원 표지 — 하나라도 빠지면 **다른 인물**이다:
  - [ ] 근육질 노인 경비
  - [ ] 모자+조끼
  - [ ] 여유로운 미소. 공대 최강자 개그 캐릭터
...
|---|---|---|
| 1 | normal | 기본 — 평상시 얼굴 |
| 2 | laughing | 호탕한 웃음 — 입을 크게 벌리고 눈을 감는다 |
| 3 | mighty | 위풍당당 — 턱을 들고 가슴을 편 각도 |
